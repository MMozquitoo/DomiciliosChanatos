...
app = FastAPI(title="Chanatos WhatsApp Agent", version="2.0.0", lifespan=lifespan)
...
async def health_check():
    ...
    if error_configuracion:
        return {"status": "error", "service": "chanatos-agent", "detalle": error_configuracion}
